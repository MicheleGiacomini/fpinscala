...
class NonblockingSuite extends PropSuite:
  ...
  test("Nonblocking.choiceViaChoiceN")(
    genParInt ** genParInt ** genParBoolean
  ) { case t ** f ** p =>
  ...
  test("Nonblocking.choiceViaFlatMap")(
    genParInt ** genParInt ** genParBoolean
  ) { case t ** f ** p =>
  ...
  private def checkChoice(t: Par[Int], f: Par[Int], p: Par[Boolean])(
      choice: Par[Int]
  ) =
  ...
  private def checkChoiceN(p: Par[Int], ps: List[Par[String]])(
      choice: Par[String]
  ) =
    val actual = choice.run(es)
  ...
  private def checkFlatMap(p: Par[Int], ps: Map[Int, Par[String]])(
      choice: Par[String]
  ) =
